...
#define UE_PROJECT_NAME Longvinter
#define UE_TARGET_NAME LongvinterEditor
...
#define EOS_ENABLE_STRICT_WARNINGS __pragma(warning(push))__pragma(warning(error:4244))__pragma(warning(error:4838))
#define EOS_DISABLE_STRICT_WARNINGS __pragma(warning(pop))
#define EOS_HAS_ORCHESTRATORS 1
#define EOS_HAS_AUTHENTICATION 1
#define EOS_HAS_IMAGE_DECODING 1
#define ONLINESUBSYSTEMREDPOINTEOS_API DLLIMPORT
#define EOS_SDK_LINK_VERSION "23143668-v1.15.4"
#define REDPOINTLIBHYDROGEN_API DLLIMPORT
#define DESKTOPPLATFORM_API DLLIMPORT
#define REDPOINTEOSEDITOR_API DLLEXPORT
