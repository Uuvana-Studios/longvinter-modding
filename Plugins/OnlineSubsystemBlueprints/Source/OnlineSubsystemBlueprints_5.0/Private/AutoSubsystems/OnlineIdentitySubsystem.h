...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Online|Identity")
    void ClearCachedAuthToken(FUniqueNetIdRepl UserId);

    // @result-delegates-not-compatible: FOnGetLinkedAccountAuthTokenCompleteDelegate(int32 LocalUserNum, bool bWasSuccessful, const FExternalAuthToken& AuthToken)
    // void GetLinkedAccountAuthToken(int32 LocalUserNum);
