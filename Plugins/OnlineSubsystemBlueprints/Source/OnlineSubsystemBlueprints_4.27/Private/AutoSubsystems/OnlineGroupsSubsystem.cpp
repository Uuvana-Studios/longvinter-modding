...
UOnlineGroupsSubsystem::UOnlineGroupsSubsystem()
{
    ...
    UE_LOG(LogOnlineBlueprint, Verbose, TEXT("OnlineGroupsSubsystem subsystem initialized in context %s"), *WorldContext->ContextHandle.ToString());
...
void UOnlineGroupsSubsystem::SetNamespace(FString Ns)
{
    check(!this->HasAnyFlags(RF_ClassDefaultObject));
