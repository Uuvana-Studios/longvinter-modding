...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(FFriends_FriendSettingsUpdated_BP, FUniqueNetIdRepl, UserId, bool, bWasSuccessful, bool, bWasUpdate, FFriendSettingsData, Settings, FString, ErrorStr);
...
public:
    ...
    // void UpdateFriendInvitePolicySettings(const FUniqueNetId& LocalUserId, const EFriendInvitePolicy FriendInvitePolicy, const bool bAffectsExistingInvites, FOnSettingsOperationComplete Delegate);
