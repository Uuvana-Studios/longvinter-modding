...
// DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FParty_PartyConfigChanged_BP, OnPartyConfigChangedConst, Param1, const FUniqueNetId&, LocalUserId, const FOnlinePartyId&, PartyId, const FPartyConfiguration&, PartyConfig);

// @parameters-not-compatible
// DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FParty_PartyDataReceived_BP, OnPartyDataReceivedConst, Param1, const FUniqueNetId&, LocalUserId, const FOnlinePartyId&, PartyId, const FOnlinePartyData&, PartyData);
...
// @parameters-not-compatible
// DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(FParty_PartyMemberDataReceived_BP, OnPartyMemberDataReceivedConst, Param1, const FUniqueNetId&, LocalUserId, const FOnlinePartyId&, PartyId, const FUniqueNetId&, MemberId, const FOnlinePartyData&, PartyData);
...
// @parameters-not-compatible
// DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FParty_PartyJoinRequestReceived_BP, OnPartyGroupJoinRequestReceived, Param1, const FUniqueNetId&, LocalUserId, const FOnlinePartyId&, PartyId, const IOnlinePartyPendingJoinRequestInfo&, JoinRequestInfo);
...
// @parameters-not-compatible
// DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FParty_QueryPartyJoinabilityReceived_BP, OnQueryPartyJoinabilityGroupReceived, Param1, const FUniqueNetId&, LocalUserId, const FOnlinePartyId&, PartyId, const IOnlinePartyPendingJoinRequestInfo&, JoinRequestInfo);
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Online|Party")
    bool UpdatePartyData(FUniqueNetIdRepl LocalUserId, UPartyId* PartyId, UReadablePartyData* PartyData);

    UFUNCTION(BlueprintCallable, Category = "Online|Party")
    bool UpdatePartyMemberData(FUniqueNetIdRepl LocalUserId, UPartyId* PartyId, UReadablePartyData* PartyMemberData);
    ...
    UFUNCTION(BlueprintPure, Category = "Online|Party")
    UReadablePartyData* GetPartyData(FUniqueNetIdRepl LocalUserId, UPartyId* PartyId);

    UFUNCTION(BlueprintPure, Category = "Online|Party")
    UReadablePartyData* GetPartyMemberData(FUniqueNetIdRepl LocalUserId, UPartyId* PartyId, FUniqueNetIdRepl MemberId);
    ...
    // @generator-incompatible
    // bool GetPartyMembers(const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, TArray<TSharedRef<FOnlinePartyMember>>& OutPartyMembersArray);

    UFUNCTION(BlueprintPure, Category = "Online|Party")
    bool GetPendingInvites(FUniqueNetIdRepl LocalUserId, TArray<UOnlinePartyJoinInfo*>& OutPendingInvitesArray);

    // @generator-incompatible
    // bool GetPendingInvites(const FUniqueNetId& LocalUserId, TArray<TSharedRef<IOnlinePartyJoinInfo>>& OutPendingInvitesArray);
    ...
    // @generator-incompatible
    // bool GetPendingJoinRequests(const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, TArray<TSharedRef<IOnlinePartyPendingJoinRequestInfo>>& OutPendingJoinRequestArray);
    ...
    // @generator-incompatible
    // FDelegateHandle AddOnPartyConfigChangedDelegate_Handle(const FOnPartyConfigChangedDelegate& Delegate);

    // @generator-incompatible
    // FDelegateHandle AddOnPartyDataReceivedDelegate_Handle(const FOnPartyDataReceivedDelegate& Delegate);

    // @generator-incompatible
    // FDelegateHandle AddOnPartyMemberDataReceivedDelegate_Handle(const FOnPartyMemberDataReceivedDelegate& Delegate);

    // @generator-incompatible
    // FDelegateHandle AddOnPartyJoinRequestReceivedDelegate_Handle(const FOnPartyJoinRequestReceivedDelegate& Delegate);

    // @generator-incompatible
    // FDelegateHandle AddOnQueryPartyJoinabilityReceivedDelegate_Handle(const FOnQueryPartyJoinabilityReceivedDelegate& Delegate);
