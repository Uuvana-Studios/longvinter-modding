...
public:
    ...
    // @result-delegates-not-compatible: FOnGroupsRequestCompleted(FGroupsResult Param1)
    // void QueryGroupDenylist(FUniqueNetIdRepl ContextUserId, FUniqueNetIdRepl GroupId);

    // @generator-incompatible
    // TSharedPtr<const IGroupDenylist> GetCachedGroupDenylist(const FUniqueNetId& ContextUserId, const FUniqueNetId& GroupId);
