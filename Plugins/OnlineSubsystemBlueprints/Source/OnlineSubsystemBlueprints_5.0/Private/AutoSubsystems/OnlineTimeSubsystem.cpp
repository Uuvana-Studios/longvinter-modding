...
UOnlineTimeSubsystem::UOnlineTimeSubsystem()
{
    ...
    UE_LOG(LogOnlineBlueprint, Verbose, TEXT("OnlineTimeSubsystem subsystem initialized in context %s"), *WorldContext->ContextHandle.ToString());
    ...
    if (Handle.IsValid())
    {
        ...
        this->DelegateHandle_OnQueryServerUtcTimeComplete = Handle->AddOnQueryServerUtcTimeCompleteDelegate_Handle(
            FOnQueryServerUtcTimeComplete::FDelegate::CreateWeakLambda(this, [this](bool Param1, const FString& Param2, const FString& Param3) {
