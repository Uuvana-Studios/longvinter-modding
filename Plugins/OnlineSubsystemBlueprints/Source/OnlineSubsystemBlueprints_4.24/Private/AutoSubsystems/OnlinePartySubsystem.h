...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(FParty_PartyJoinRequestReceived_BP, FUniqueNetIdRepl, LocalUserId, UPartyId*, PartyId, FUniqueNetIdRepl, SenderId, FString, Platform, UReadablePartyData*, PartyData);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(FParty_QueryPartyJoinabilityReceived_BP, FUniqueNetIdRepl, LocalUserId, UPartyId*, PartyId, FUniqueNetIdRepl, SenderId, FString, Platform, UReadablePartyData*, PartyData);
...
private:
    ...
    FDelegateHandle DelegateHandle_OnPartyJoinRequestReceived;
    FDelegateHandle DelegateHandle_OnPartyJIPRequestReceived;
    FDelegateHandle DelegateHandle_OnQueryPartyJoinabilityReceived;
...
public:
    ...
    UPROPERTY(BlueprintAssignable, Category = "Online|Party")
    FParty_PartyJoinRequestReceived_BP OnPartyJoinRequestReceived;

    UPROPERTY(BlueprintAssignable, Category = "Online|Party")
    FParty_PartyJIPRequestReceived_BP OnPartyJIPRequestReceived;

    UPROPERTY(BlueprintAssignable, Category = "Online|Party")
    FParty_QueryPartyJoinabilityReceived_BP OnQueryPartyJoinabilityReceived;
